...
//			if(p==0)  actualWeight[p]=fabs(scalef)*lumiWeight*pweight[i]*pileupWeight;
//			else  actualWeight[p]=2*fabs(scalef)*lumiWeight*pweight[i]*pileupWeight;
...
//	run("/home/pku/anying/cms/file_in_cms/files_weighted/outZA-mu-ele_nozepp.root");
	run("/home/pku/anying/cms/RunII2016/analysis_code/aa2/ScalSeq/output-slimmed-rootfiles/optimal_ZA_pweight.root");
