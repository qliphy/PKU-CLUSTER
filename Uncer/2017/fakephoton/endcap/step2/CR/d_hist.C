...
//	t->SetBranchAddress("deltaetajj", &deltaetajj);
	...
	{
		t->GetEntry(j);
		if( !((lep==13||lep==11) && ( fabs(photoneta)<2.5&&fabs(photoneta)>1.566 ) ) ) continue;
...
int d_hist(){
	TH2D* h0 =  run("/home/pku/anying/cms/RunII2017/aa2/Endcap/output-slimmed-rootfiles/optimal_2017_plj_endcap.root",0);
	TH2D* hup = run("/home/pku/anying/cms/RunII2017/aa2/Endcap/output-slimmed-rootfiles/optimal_2017_plj_endcap_up.root",1);
	TH2D*hdown= run("/home/pku/anying/cms/RunII2017/aa2/Endcap/output-slimmed-rootfiles/optimal_2017_plj_endcap_down.root",2);
