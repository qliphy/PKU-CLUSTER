...
//
   ...
   ifstream f1;
   f1.open("../../plj-plot/EleEndcap/ele-endcap-pljweight/pljweight.txt");
   Double_t scalef_f[9];
   for(Int_t i=0;i<9;i++){
      f1>>scalef_f[i];
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
     ...
     //if(photonet>20 &&  photonet<25)      {int i=0;scalef_tmp = 0.48;}   
     if(photonet>25 &&  photonet<30)      {int i=0+1;scalef_tmp = scalef_f[i];}
     //if(photonet>25 &&  photonet<30)      {int i=0+1;scalef_tmp = 0.48;}
     ...
     if(photonet>60 &&  photonet<100)      {int i=6+1;scalef_tmp = scalef_f[i];}
     if(photonet>100/*&&  photonet<400*/) {int i=7+1;scalef_tmp = scalef_f[i];} 
