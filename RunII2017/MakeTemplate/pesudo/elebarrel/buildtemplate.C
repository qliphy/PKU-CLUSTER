...
double delta_R(Double_t eta1, Double_t phi1, Double_t eta2, Double_t phi2);
 ...
 int photon_isprompt[6],lep,isprompt,isTrue;
...
// Double_t highpt[ptnumber]={25,30,35,40,45,50,60,80,120,400};
 Double_t lowpt[ptnumber] ={20,25,30,40,65};
 Double_t highpt[ptnumber]={25,30,40,65,400};
 TH1D* h11[ptnumber];
 TH1D* h21[ptnumber];
...
// tree->SetBranchAddress("ngoodeles",&ngoodeles);
 ...
 tree->SetBranchAddress("isTrue",&isTrue);
