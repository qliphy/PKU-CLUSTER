...
TString dir = "../../endcap/mu/root/";
TString dir1 = "../../endcap/mu/roofit/txt/";
ofstream file3("../../endcap/mu/roofit/info_roofit_endcap.txt");
void fit(float lowpt, float highpt, float lowchiso, float highchiso){
//TString b="chiso5-12_";
	TFile* fdata = TFile::Open(Form(dir+"pdata_fake_pt%0.f-%0.f_chiso%0.f-%0.f.root",lowpt,highpt,lowchiso,highchiso));
	TFile* ftrue = TFile::Open(Form(dir+"pdata_photonreal_pt%0.f_%0.f.root",lowpt,highpt));
