...
//=========  (Fri Oct 18 21:52:07 2019) by ROOT version6.06/01
...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(-51.25,-29.01827,423.75,194.1992);
   pad1->SetFillColor(0);
   ...
   hs_stack_1->SetMaximum(174.1096);
   ...
   hist__7->SetBinContent(1,7.684335);
   hist__7->SetBinContent(2,32.11423);
   hist__7->SetBinContent(3,20.99423);
   hist__7->SetBinContent(4,16.0899);
   hist__7->SetBinContent(5,7.592543);
   hist__7->SetBinError(1,0.317437);
   hist__7->SetBinError(2,0.6489378);
   hist__7->SetBinError(3,0.5246919);
   hist__7->SetBinError(4,0.4593365);
   hist__7->SetBinError(5,0.3155353);
