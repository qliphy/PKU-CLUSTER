...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   ifstream f1;
//   f1.open("/afs/cern.ch/user/y/yian/work/PKU-Cluster/RunII2017/plj/plj-plot/MuonBarrel/pljweight.txt");
//   f1.open("/afs/cern.ch/user/y/yian/work/PKU-Cluster/Uncer/2017/fakephoton/mubarrel/step1/pljweight_up.txt");
//   f1.open("/home/pku/anying/cms/RunII2017/uncer/mubarrel/pljweight_down.txt");
   f1.open("/afs/cern.ch/user/y/yian/work/PKU-Cluster/RunII2017/plj/plj-plot/MuonBarrel/pljweight.txt");
   Double_t scalef_f[8];
   for(Int_t i=0;i<8;i++){
      f1>>scalef_f[i];
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
     ...
     if(photonet>60 &&  photonet<100)     {int i=6;scalef_tmp =scalef_f[i];}
