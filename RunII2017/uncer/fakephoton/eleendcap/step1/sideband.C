...
void open(double lowpt,double highpt,TString name1,TString name2,TString name3){
	...
	ifstream f1,f2,f3;
        f1.open("/home/pku/anying/cms/RunII2017/MakeTemplate/ElectronEndcap/ZAfit/txt/fakerate_"+name1+Form("_pt%0.f_%0.f.txt",lowpt,highpt));
        f2.open("/home/pku/anying/cms/RunII2017/MakeTemplate/ElectronEndcap/ZAfit/txt/fakerate_"+name2+Form("_pt%0.f_%0.f.txt",lowpt,highpt));
        f3.open("/home/pku/anying/cms/RunII2017/MakeTemplate/ElectronEndcap/ZAfit/txt/fakerate_"+name3+Form("_pt%0.f_%0.f.txt",lowpt,highpt));
        double ff1,ff2,ff3;
...
int sideband(){
	...
	Double_t lowpt[num]= {20,25,30,35,50,60};
	Double_t highpt[num]={25,30,35,50,60,400};
	for(int i = 0;i<num;i++){
