...
//  Double_t pileupWeight;
	...
	for(Int_t j=0; j<t->GetEntries();j++)
	{
        p=0;
	t->GetEntry(j);
        if( !( Mjj>150 && Mjj<400 /*&& detajj>2.5 && zepp<2.4*/) ) continue;
        for(Int_t i=0;i<9;i++){
           if( flag==true  && (i==5 || i==7) ) continue;
...
//	run("/home/pku/anying/cms/file_in_cms/2017RunIIrootfiles/2017cutla/cutla-outZA_pweight.root");
	run("/home/pku/anying/cms/RunII2018/aa2/ScalSeq/output-slimmed-rootfiles/optimal_2018_ZA_pweight_2018.root");
