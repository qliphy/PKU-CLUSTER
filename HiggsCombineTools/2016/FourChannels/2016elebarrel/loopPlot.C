...
void loopPlot() {
	...
	std::string pathToTrees = "/data/pku/home/anying/cms/CMSSW_8_0_26_patch2/analysis_code/aa2/";
...
// set mcsig information
	...
	for (int ii = 0; ii < nMCSig; ii++) {
		fMCSig.push_back(pathToTrees+"optimal_cutla-out" + mcLabelsSig[ii] + ".root");
	}
