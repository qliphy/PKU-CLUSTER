...
// Thu Jun  6 12:47:21 2019 by ROOT version 6.06/01
// from TTree ZPKUCandidates/ZPKU Candidates
// found on file: ZA-EWK-JEC.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("ZA-EWK-JEC.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("ZA-EWK-JEC.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("ZA-EWK-JEC.root:/treeDumper");
