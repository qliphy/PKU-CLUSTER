...
process.Ztoee.decay = cms.string("calibratedPatElectrons@+ calibratedPatElectrons@-")
...
process.calibratedPatElectrons.electrons = cms.InputTag("goodElectrons")
...
process.goodElectrons.src = cms.InputTag('slimmedElectrons::PAT')
#process.vetoElectrons.src = "slimmedElectrons"
process.vetoElectrons.src =cms.InputTag('slimmedElectrons::PAT')
process.load('PhysicsTools.PatAlgos.modifiedElectrons_cfi')
process.modifiedElectrons.src = "goodElectrons"
...
process.leptonSequence = cms.Sequence(process.muSequence +
				process.vetoElectrons + process.goodElectrons +
...
process.source = cms.Source("PoolSource",
				fileNames = cms.untracked.vstring( 
                            '/store/mc/RunIISummer16MiniAODv2/LLAJJ_EWK_MLL-50_MJJ-120_13TeV-madgraph-pythia8/MINIAODSIM/PUMoriond17_80X_mcRun2_asymptotic_2016_TrancheIV_v6-v1/50000/08DCD9BB-2C25-E711-90C9-C454449229AF.root' ),
				eventsToProcess = cms.untracked.VEventRange('1:1:24-1:1:24'),
				)
