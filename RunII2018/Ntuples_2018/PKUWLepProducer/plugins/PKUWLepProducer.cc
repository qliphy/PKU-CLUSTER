// -*- C++ -*-
//
// Package:    VAJets/PKUWLepProducer
// Class:      PKUWLepProducer
// 
/**\class PKUWLepProducer PKUWLepProducer.cc VAJets/PKUWLepProducer/plugins/PKUWLepProducer.cc
...
class PKUWLepProducer : public edm::EDProducer {
public:
  explicit PKUWLepProducer(const edm::ParameterSet&);
  ~PKUWLepProducer();
...
//
PKUWLepProducer::PKUWLepProducer(const edm::ParameterSet& iConfig):
...
PKUWLepProducer::~PKUWLepProducer()
{
...
void
PKUWLepProducer::produce(edm::Event& iEvent, const edm::EventSetup& iSetup)
{
   using namespace edm;
...
void 
PKUWLepProducer::beginJob()
{
}

// ------------ method called once each job just after ending the event loop  ------------
void 
PKUWLepProducer::endJob() {
}

// ------------ method called when starting to processes a run  ------------
/*
void
PKUWLepProducer::beginRun(edm::Run const&, edm::EventSetup const&)
{
}
*/
...
/*
void
PKUWLepProducer::endRun(edm::Run const&, edm::EventSetup const&)
{
}
*/
...
/*
void
PKUWLepProducer::beginLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}
*/
...
/*
void
PKUWLepProducer::endLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}
*/
...
void
PKUWLepProducer::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
PKUWLepProducer::getNeutrinoP4(const reco::Candidate& met, const reco::Candidate& lep, int lepType){//lepType 0 ele, 1 mu
  ...
  int type=0; // use the small abs real root
...
DEFINE_FWK_MODULE(PKUWLepProducer);
