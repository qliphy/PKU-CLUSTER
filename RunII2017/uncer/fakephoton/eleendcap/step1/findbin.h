...
// Mon May  6 18:54:22 2019 by ROOT version 6.06/01
// from TTree demo/demo
// found on file: DMuon.root
//////////////////////////////////////////////////////////
...
#ifdef findbin_cxx
findbin::findbin(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("DMuon.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("DMuon.root");
      }
...
Int_t findbin::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t findbin::LoadTree(Long64_t entry)
{
...
void findbin::Show(Long64_t entry)
{
...
Int_t findbin::Cut(Long64_t entry)
{
