...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   ifstream f1;
   f1.open("/home/pku/anying/cms/Uncer/2016/fakephoton/elebarrel/step1/pljweight.txt");
//   f1.open("/home/pku/anying/cms/Uncer/2016/fakephoton/elebarrel/step1/pljweight_up.txt");
//   f1.open("/home/pku/anying/cms/Uncer/2016/fakephoton/elebarrel/step1/pljweight_down.txt");
   Double_t scalef_f[9];
   for(Int_t i=0;i<9;i++){
      f1>>scalef_f[i];
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
     ...
     if(photonet>45 &&  photonet<50)      {int i=4;scalef_tmp = scalef_f[i];}
     if(photonet>50 &&  photonet<60)      {int i=5;scalef_tmp = scalef_f[i];}
     if(photonet>60 &&  photonet<80)      {int i=6;scalef_tmp = scalef_f[i];}
     if(photonet>80 &&  photonet<120)     {int i=7;scalef_tmp = scalef_f[i];}
     if(photonet>120/*&&  photonet<400*/) {int i=8;scalef_tmp = scalef_f[i];} 
