...
Double_t weight[9];
TFile* f1 = new TFile("./plj-hist/cutla-outDMuon_plj_h.root");
TFile* f2 = new TFile("./plj-hist/cutla-outDMuon_h.root");
...
const char *name[9]={"20~25","25~30","30~35","35~40","40~50","50~60","60~80","80~120","120~400"};
for(Int_t i=0;i<9;i++){
