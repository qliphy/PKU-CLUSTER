...
//        t_ZA[i]->DrawNormalized("HIST");
        ...
        else if(i==1)    ll[i]->AddEntry(t_ZA[i],"mjj_JES_up");
        else if(i==2)    ll[i]->AddEntry(t_ZA[i],"mjj_JES_down");
        ll[i]->Draw();
...
//          t_ZA[i]->Scale(scale_factor[i]);
          ...
          else if(i==1)    l2->AddEntry(t_ZA[i],"mjj_JES_up");
          else if(i==2)    l2->AddEntry(t_ZA[i],"mjj_JES_down");
