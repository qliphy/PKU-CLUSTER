...
//   f1.open("../../plj-plot/Muon/muon-barrel-pljweight/pljweight.txt");
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
     ...
     if(photonet>60 &&  photonet<80)      {int i=5;scalef_tmp =scalef_f[i];}
     if(photonet>80 &&  photonet<120)     {int i=6;scalef_tmp =scalef_f[i];}
     if(photonet>120/*&&  photonet<400*/) {int i=7;scalef_tmp =scalef_f[i];} 
