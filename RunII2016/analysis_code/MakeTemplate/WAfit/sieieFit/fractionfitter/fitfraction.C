...
//TString b="chiso5-12_";
	...
	TH1F* hdf_ = (TH1F*)fdataF->Get(Form("h3_pt%0.f_%0.f",lowpt,highpt));
//	TH1F* hdf_ = (TH1F*)fdata->Get(Form("hwaFc_pt%0.f-%0.f",lowpt,highpt));
//      TH1F* hdt_ = (TH1F*)fmc->Get(Form("hmcwaT_pt%0.f-%0.f",lowpt,highpt));
	TH1F* hdt_ = (TH1F*)fdataT->Get(Form("h4_pt%0.f_%0.f",lowpt,highpt));
	TH1F* hmf = (TH1F*)fmcF->Get(Form("h1_pt%0.f_%0.f",lowpt,highpt));
	TH1F* hmt = (TH1F*)fmcT->Get(Form("h2_pt%0.f_%0.f",lowpt,highpt));
...
/*        TH1F* hdata =(TH1F*)hdata_->Clone(); 
        TH1F* hdt =  (TH1F*)hdt_->Clone(); 
        TH1F* hdf =  (TH1F*)hdf_->Clone(); 
