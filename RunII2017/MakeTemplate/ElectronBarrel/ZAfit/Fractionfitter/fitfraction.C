...
TFile* fdataT = TFile::Open("../root/Data_template-cutlep-outDMuon.root");
TFile* fdataF = TFile::Open("../root/Fake_template-cutlep-outDMuon.root");
TFile* fmcT = TFile::Open("../root/True_template-outZA-EWK.root");
TString dir = "./txt/"; 
...
//TString b="chiso5-12_";
	...
	TH1F* hdata_ = (TH1F*)fdataT->Get(Form("h3_pt%0.f_%0.f",lowpt,highpt));
	TH1F* hfake_ = (TH1F*)fdataF->Get(Form("h2_pt%0.f_%0.f",lowpt,highpt));
	TH1F* htrue_ = (TH1F*)fmcT->Get(Form("h1_pt%0.f_%0.f",lowpt,highpt));
	TH1F* hsieie = (TH1F*)fmcT->Get(Form("hsieie_pt%0.f_%0.f",lowpt,highpt));
