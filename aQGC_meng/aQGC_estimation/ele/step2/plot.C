...
void cmsLumi(bool channel) //0 for el
{
	...
	latex.DrawLatex(0.76,0.96,Form("35.866 fb^{-1} (%d TeV)", (beamcomenergytev)));
}
...
void plot(){
	setTDRStyle();
	Double_t a2[5] = {0.000184374, 0.00508668, 0.0274636, 0.190694, 13.2631};
	Double_t a1[5] = {0.00244175, 0.0332563, 0.0733085, 0.340528, 1.09925};
