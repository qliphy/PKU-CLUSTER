...
int d_hist(){
	TH2D* h0 = run("/home/pku/anying/cms/RunII2017/aa2/ScalSeq/output-slimmed-rootfiles/optimal_2017_plj_mubarrel.root",0);
	TH2D* hup = run("/home/pku/anying/cms/RunII2017/aa2/ScalSeq/output-slimmed-rootfiles/optimal_2017_plj_mubarrel_up.root",1);
	TH2D* hdown = run("/home/pku/anying/cms/RunII2017/aa2/ScalSeq/output-slimmed-rootfiles/optimal_2017_plj_mubarrel_down.root",2);
