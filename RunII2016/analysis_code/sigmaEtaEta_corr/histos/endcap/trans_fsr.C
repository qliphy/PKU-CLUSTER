	...
	for(Long64_t i=0;i<entries;i++){
		...
		double pt_tmp=-99;
                ...
                for(int j=0;j<6;j++){
                        ...
                        if(photon_pt[j]>15 && photon_hoe[j]<0.0219 && photon_nhiso[j]<(1.715 + 0.0163*photon_pt[j] + 0.000014*photon_pt[j]*photon_pt[j]) && photon_phoiso[j]<(3.863 + 0.0034*photon_pt[j]) && photon_chiso[j]<0.442 && tm1>70 &&tm1<110) {
