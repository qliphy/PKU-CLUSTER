...
void EDBRHistoMaker::Loop(std::string outFileName) {
	...
	double r2=gRandom->Rndm(jentry*2);
		...
		if (drll>0.3 &&drla>0.7 && drla2>0.7 && (isnotwets > 0 || iswjets > 0 || iszjets > 0 || isttjets > 0)&&lep == 13 &&  (  HLT_Mu5 > 0|| HLT_Mu2 > 0 ) && ptlep1 > 20. && ptlep2 > 20. && fabs(etalep1) < 2.4 && fabs(etalep2) < 2.4 && nlooseeles == 0 && nloosemus < 3 && massVlep > 70. && massVlep < 110. && photonet > 20.&& fabs(photoneta)<2.5&&fabs(photoneta)>1.566 && jet1pt> 30 && jet2pt > 30 && fabs(jet1eta)< 4.7 && fabs(jet2eta)<4.7 && Mjj > 150&&Mjj<400) {
			numbe_out++;
			treename->Fill();
		}
		else
...
//                }
		...
		if(drla==10) drla=-10;
		if(drla2==10) drla2=-10;
		if (drll>0.3 && drla>0.7 && drla2>0.7 && (isnotwets > 0 || iswjets > 0 || iszjets > 0 || isttjets > 0)&&lep == 13 &&( HLT_Mu2 > 0|| HLT_Mu5>0) && ptlep1 > 20. && ptlep2 > 20. && fabs(etalep1) < 2.4 && fabs(etalep2) < 2.4 && nlooseeles == 0 && nloosemus < 3 && massVlep > 70. && massVlep < 110. && photonet > 20.&& fabs(photoneta)<2.5&&fabs(photoneta)>1.566 && jet1pt> 30 && jet2pt > 30 && fabs(jet1eta)< 4.7 && fabs(jet2eta)<4.7&& Mjj > 150 && Mjj<400) {
			numbe_out++;
			treename->Fill();
