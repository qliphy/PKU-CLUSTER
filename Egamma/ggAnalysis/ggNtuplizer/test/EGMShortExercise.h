...
// Mon Sep 10 15:11:52 2018 by ROOT version 6.10/09
// from TTree EventTree/Event data (tag V09_04_09_00)
// found on file: ggtree_data.root
//////////////////////////////////////////////////////////

#ifndef EGMShortExercise_h
#define EGMShortExercise_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   EGMShortExercise(TTree *tree=0);
   virtual ~EGMShortExercise();
...
#ifdef EGMShortExercise_cxx
EGMShortExercise::EGMShortExercise(TTree *tree) : fChain(0) 
{
...
EGMShortExercise::~EGMShortExercise()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t EGMShortExercise::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t EGMShortExercise::LoadTree(Long64_t entry)
{
...
void EGMShortExercise::Init(TTree *tree)
{
...
Bool_t EGMShortExercise::Notify()
{
...
void EGMShortExercise::Show(Long64_t entry)
{
...
Int_t EGMShortExercise::Cut(Long64_t entry)
{
...
#endif // #ifdef EGMShortExercise_cxx
