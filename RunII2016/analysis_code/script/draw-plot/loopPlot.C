...
void loopPlot() {
	...
	std::string outputDir = "./output_new";
...
// Setup names of data files for trees.
	...
	std::cout << "set data imformation, we have " << nDATA << "data file"
			<< std::endl;
	std::string dataLabels[nDATA] = { "cutla-outDMuon" };
...
// set mc imformation
		...
		std::cout << "set data imformation, we have " << nMC << "mc file"
				<< std::endl;
		//std::string mcLabels[nMC] = { "ST", "TTA", "plj_DMuon", "VV", "plj_DMuon",
		//		"WA", "plj_DMuon", "ZA" };
		std::string mcLabels[nMC] = { /*"cutLEP-outDMuon_plj_weight"*/"TTJets","WJets","ZJets_FX","ST", "TTA", "VV",
				"WA", "ZA" };
