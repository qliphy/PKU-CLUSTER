...
// Tue Apr 30 19:47:25 2019 by ROOT version 6.06/01
...
static constexpr Int_t kMaxSize = 1;
class hltGenTree {
public :
...
// Fixed size dimensions of array or collections stored in the TTree if any.
 ...
 //EleStructs::EleStruct *ele;
   ...
   TBranch        *b_egHLT_et;   //!
   TBranch        *b_egHLT;   //!
   TBranch        *b_egHLT_nrgy;   //!
   TBranch        *b_egHLT_eta;   //!
   TBranch        *b_egHLT_phi;   //!
   TBranch        *b_egHLT_hadem;   //!
   TBranch        *b_egHLT_sigmaIEtaIEta;   //!
   TBranch        *b_egHLT_dEtaIn;   //!
   TBranch        *b_egHLT_dPhiIn;   //!
   TBranch        *b_egHLT_nrMissHits;   //!
   TBranch        *b_egHLTUS;   //!
   TBranch        *b_rho;   //!
   TBranch        *b_rhoAlt;   //!

   hltGenTree(TTree *tree=0);
   virtual ~hltGenTree();
   virtual Int_t    Cut(Long64_t entry);
   virtual Int_t    GetEntry(Long64_t entry);
   virtual Long64_t LoadTree(Long64_t entry);
   virtual void     Init(TTree *tree);
   virtual void     Loop(TString name,int j,int i);
   virtual void     endJob(TString name);
   virtual Bool_t   Notify();
   virtual void     Show(Long64_t entry = -1);

   Double_t etbins[6]={0,30,60,80,200,400};
   Double_t nrgybins[7]={0,50,100,150,200,300,400};
...
#ifdef hltGenTree_cxx
hltGenTree::hltGenTree(TTree *tree) : fChain(0) 
{
...
hltGenTree::~hltGenTree()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t hltGenTree::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t hltGenTree::LoadTree(Long64_t entry)
{
...
void hltGenTree::Init(TTree *tree)
{
...
//   fChain->SetBranchAddress("egHLT", &egHLT_et, &b_egHLT_et);
//   fChain->SetBranchAddress("egHLT", &egHLT_nrgy, &b_egHLT_nrgy);
//   fChain->SetBranchAddress("egHLT", &egHLT_eta, &b_egHLT_eta);
//   fChain->SetBranchAddress("egHLT", &egHLT_phi, &b_egHLT_phi);
//   fChain->SetBranchAddress("egHLT", &egHLT_hadem, &b_egHLT_hadem);
//   fChain->SetBranchAddress("egHLT", &egHLT_sigmaIEtaIEta, &b_egHLT_sigmaIEtaIEta);
//   fChain->SetBranchAddress("egHLT", &egHLT_dEtaIn, &b_egHLT_dEtaIn);
//   fChain->SetBranchAddress("egHLT", &egHLT_dPhiIn, &b_egHLT_dPhiIn);
//   fChain->SetBranchAddress("egHLT", &egHLT_nrMissHits, &b_egHLT_nrMissHits);
 /*  fChain->SetBranchAddress("egHLT_nrgy", &egHLT_nrgy, &b_egHLT_nrgy);
   fChain->SetBranchAddress("egHLT_eta", &egHLT_eta, &b_egHLT_eta);
   fChain->SetBranchAddress("egHLT_phi", &egHLT_phi, &b_egHLT_phi);
   fChain->SetBranchAddress("egHLT_hadem", &egHLT_hadem, &b_egHLT_hadem);
   fChain->SetBranchAddress("egHLT_sigmaIEtaIEta", &egHLT_sigmaIEtaIEta, &b_egHLT_sigmaIEtaIEta);
   fChain->SetBranchAddress("egHLT_dEtaIn", &egHLT_dEtaIn, &b_egHLT_dEtaIn);
   fChain->SetBranchAddress("egHLT_dPhiIn", &egHLT_dPhiIn, &b_egHLT_dPhiIn);
   fChain->SetBranchAddress("egHLT_nrMissHits", &egHLT_nrMissHits, &b_egHLT_nrMissHits);*/
...
void hltGenTree::Show(Long64_t entry)
{
...
void hltGenTree::endJob(TString name){
/*for(int i=0;i<2;i++){
delete het[i];
delete hnrgy[i];
delete heta[i];
...
delete file;
cout<<name<<" run successfully ^o^"<<endl;
cout<<"*********end job***********"<<endl;

}
Int_t hltGenTree::Cut(Long64_t entry)
{
