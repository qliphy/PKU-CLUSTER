...
// Sat Sep  1 22:02:00 2018 by ROOT version 6.06/01
// from TTree ZPKUCandidates/ZPKU Candidates
// found on file: WAJ-fxfx.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("WAJ-fxfx.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("WAJ-fxfx.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("WAJ-fxfx.root:/treeDumper");
...
//inherent branches
   ...
   ExTree->Branch("Mla_f", &Mla_f, "Mla_f/D");
   ExTree->Branch("Mla2", &Mla2, "Mla2/D");
   ExTree->Branch("Mla2_f", &Mla2_f, "Mla2_f/D");
   ExTree->Branch("Mva", &Mva, "Mva/D");
   ExTree->Branch("Mva_f", &Mva_f, "Mva_f/D");
   ...
   ExTree->Branch("genjet_pt", &genjet_pt,  "genjet_pt[6]/D");
   ExTree->Branch("genjet_eta",&genjet_eta, "genjet_eta[6]/D");
   ExTree->Branch("genjet_phi",&genjet_phi, "genjet_phi[6]/D");
   ExTree->Branch("genjet_e",  &genjet_e,   "genjet_e[6]/D");
   ...
   ExTree->Branch("drla_f", &drla_f,    "drla_f/D");
   ExTree->Branch("drla2", &drla2,      "drla2/D");
   ExTree->Branch("drla2_f", &drla2_f,  "drla2_f/D");
   ...
   ExTree->Branch("jet1csv_f", &jet1csv_f,   "jet1csv_f/D");
   ExTree->Branch("jet1icsv", &jet1icsv,     "jet1icsv/D");
   ExTree->Branch("jet1icsv_f", &jet1icsv_f, "jet1icsv_f/D");
   ...
   ExTree->Branch("jet2csv_f", &jet2csv_f,   "jet2csv_f/D");
   ExTree->Branch("jet2icsv", &jet2icsv,     "jet2icsv/D");
   ExTree->Branch("jet2icsv_f", &jet2icsv_f, "jet2icsv_f/D");
   ExTree->Branch("drj1a", &drj1a,       "drj1a/D");
   ExTree->Branch("drj1a_f", &drj1a_f,   "drj1a_f/D");
   ExTree->Branch("drj2a", &drj2a,       "drj2a/D");
   ExTree->Branch("drj2a_f", &drj2a_f,   "drj2a_f/D");
   ExTree->Branch("drj1l", &drj1l,       "drj1l/D");
   ExTree->Branch("drj1l_f", &drj1l_f,   "drj1l_f/D");
   ExTree->Branch("drj2l", &drj2l,       "drj2l/D");
   ExTree->Branch("drj2l_f", &drj2l_f,   "drj2l_f/D");
   ExTree->Branch("drj1l2", &drj1l2,     "drj1l2/D");
   ExTree->Branch("drj1l2_f", &drj1l2_f, "drj1l2_f/D");
   ExTree->Branch("drj2l2", &drj2l2,     "drj2l2/D");
   ExTree->Branch("drj2l2_f", &drj2l2_f, "drj2l2_f/D");
   ExTree->Branch("Mjj", &Mjj,     "Mjj/D");
   ExTree->Branch("Mjj_f", &Mjj_f, "Mjj_f/D");
   ExTree->Branch("deltaetajj", &deltaetajj,     "deltaetajj/D");
   ExTree->Branch("deltaetajj_f", &deltaetajj_f, "deltaetajj_f/D");
   ...
   ExTree->Branch("ele1_sigmaieie", &ele1_sigmaieie, "ele1_sigmaieie/D");
   ExTree->Branch("ele2_sigmaieie", &ele2_sigmaieie, "ele2_sigmaieie/D");
   ...
   ExTree->Branch("j1metPhi_f", &j1metPhi_f, "j1metPhi_f/D");
   ExTree->Branch("j2metPhi", &j2metPhi,     "j2metPhi/D");
   ExTree->Branch("j2metPhi_f", &j2metPhi_f, "j2metPhi_f/D");
   ...
   ExTree->Branch("HLT_Ele5", &HLT_Ele5,     "HLT_Ele5/I");
   ExTree->Branch("HLT_Ele6", &HLT_Ele6,     "HLT_Ele6/I");
   ExTree->Branch("HLT_Ele7", &HLT_Ele7,     "HLT_Ele7/I");
   ...
   ExTree->Branch("HLT_Mu9", &HLT_Mu9,   "HLT_Mu9/I");
   ExTree->Branch("HLT_Mu10", &HLT_Mu10, "HLT_Mu10/I");
   ExTree->Branch("HLT_Mu11", &HLT_Mu11, "HLT_Mu11/I");
   ExTree->Branch("passFilter_HBHE", &passFilter_HBHE,                       "passFilter_HBHE_/O");
   ExTree->Branch("passFilter_HBHEIso", &passFilter_HBHEIso,                 "passFilter_HBHEIso_/O");
   ExTree->Branch("passFilter_globalTightHalo", &passFilter_globalTightHalo, "passFilter_globalTightHalo_/O");
   ExTree->Branch("passFilter_ECALDeadCell", &passFilter_ECALDeadCell,       "passFilter_ECALDeadCell_/O");
   ...
   ExTree->Branch("passFilter_badChargedHadron", &passFilter_badChargedHadron, "passFilter_badChargedHadron_/O");
   ExTree->Branch("passFilter_MetbadMuon", &passFilter_MetbadMuon,             "passFilter_MetbadMuon_/O");
...
//   ExTree->Branch("pweight", &pweight, "pweight[703]/D");
   ...
   ExTree->Branch("lhe_ele1_px", &lhe_ele1_px, "lhe_ele1_px/D");
   ExTree->Branch("lhe_ele1_py", &lhe_ele1_py, "lhe_ele1_py/D");
   ExTree->Branch("lhe_ele1_pz", &lhe_ele1_pz, "lhe_ele1_pz/D");
   ExTree->Branch("lhe_ele1_e", &lhe_ele1_e,   "lhe_ele1_e/D");
   ExTree->Branch("lhe_ele2_px", &lhe_ele2_px, "lhe_ele2_px/D");
   ExTree->Branch("lhe_ele2_py", &lhe_ele2_py, "lhe_ele2_py/D");
   ExTree->Branch("lhe_ele2_pz", &lhe_ele2_pz, "lhe_ele2_pz/D");
   ExTree->Branch("lhe_ele2_e", &lhe_ele2_e,   "lhe_ele2_e/D");
   ExTree->Branch("lhe_mu1_px", &lhe_mu1_px,   "lhe_mu1_px/D");
   ExTree->Branch("lhe_mu1_py", &lhe_mu1_py,   "lhe_mu1_py/D");
   ExTree->Branch("lhe_mu1_pz", &lhe_mu1_pz,   "lhe_mu1_pz/D");
   ExTree->Branch("lhe_mu1_e", &lhe_mu1_e,     "lhe_mu1_e/D");
   ExTree->Branch("lhe_mu2_px", &lhe_mu2_px,   "lhe_mu2_px/D");
   ExTree->Branch("lhe_mu2_py", &lhe_mu2_py,   "lhe_mu2_py/D");
   ExTree->Branch("lhe_mu2_pz", &lhe_mu2_pz,   "lhe_mu2_pz/D");
   ExTree->Branch("lhe_mu2_e", &lhe_mu2_e,     "lhe_mu2_e/D");
   ExTree->Branch("lhe_jet1_px", &lhe_jet1_px, "lhe_jet1_px/D");
   ExTree->Branch("lhe_jet1_py", &lhe_jet1_py, "lhe_jet1_py/D");
   ExTree->Branch("lhe_jet1_pz", &lhe_jet1_pz, "lhe_jet1_pz/D");
   ExTree->Branch("lhe_jet1_e", &lhe_jet1_e,   "lhe_jet1_e/D");
   ExTree->Branch("lhe_jet2_px", &lhe_jet2_px, "lhe_jet2_px/D");
   ExTree->Branch("lhe_jet2_py", &lhe_jet2_py, "lhe_jet2_py/D");
   ExTree->Branch("lhe_jet2_pz", &lhe_jet2_pz, "lhe_jet2_pz/D");
   ExTree->Branch("lhe_jet2_e", &lhe_jet2_e,   "lhe_jet2_e/D");
   ExTree->Branch("lhe_photon_px", &lhe_photon_px, "lhe_photon_px/D");
   ExTree->Branch("lhe_photon_py", &lhe_photon_py, "lhe_photon_py/D");
   ExTree->Branch("lhe_photon_pz", &lhe_photon_pz, "lhe_photon_pz/D");
   ExTree->Branch("lhe_photon_e", &lhe_photon_e,   "lhe_photon_e/D");
//inherent branches
