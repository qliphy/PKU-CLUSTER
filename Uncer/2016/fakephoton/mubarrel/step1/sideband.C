...
void open(double lowpt,double highpt,TString name1,TString name2,TString name3){
	...
	ifstream f1,f2,f3;
        f1.open("/home/pku/anying/cms/RunII2016/analysis_code/MakeTemplate/ZAfit/MuonBarrel/txt/fakerate_"+name1+Form("pt%0.f_%0.f.txt",lowpt,highpt));
        f2.open("/home/pku/anying/cms/RunII2016/analysis_code/MakeTemplate/ZAfit/MuonBarrel/txt/fakerate_"+name2+Form("pt%0.f_%0.f.txt",lowpt,highpt));
        f3.open("/home/pku/anying/cms/RunII2016/analysis_code/MakeTemplate/ZAfit/MuonBarrel/txt/fakerate_"+name3+Form("pt%0.f_%0.f.txt",lowpt,highpt));
        double ff1,ff2,ff3;
        f1>>ff1;f2>>ff2;f3>>ff3;
	fakefraction = ff3;
        cout<<lowpt<<"<pt<"<<highpt<<"; ff from ZA1:"<<ff1<<"; ff from ZA2:"<<ff2<<"; ff from ZA:"<<ff3<<"; uncertainty:"<<fabs(ff1-ff2)/(2*ff3)<<endl;
