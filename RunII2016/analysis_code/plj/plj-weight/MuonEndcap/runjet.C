...
TString dir = "/data/pku/home/anying/cms/file_in_cms/cutla/";
...
//TString outname=name+"_muendcap.root";
//TString outname=name+"_muendcap_up.root";
TString outname=name+"_muendcap_down.root";
