...
TH1D* unroll(TH2D* th2_in,Double_t* xbin, Double_t* ybin,  Int_t xbins_in, Int_t ybins_in,TString hname)
{
    ...
    TH1D* h1= new TH1D(hname, "", nbins, 0, nbins);
...
//	TH1D* t_ZA=unroll(th2_ZA, mjj_bins, mlla_bins, 4,4);
	TH1D* t_ZA=unroll(th2_ZA, mjj_bins, detajj_bins, 1,1,"t_ZA");
...
//        TH1D* t_ZA_sig=unroll(th2_ZA_sig, mjj_bins, mlla_bins, 4,4);
        TH1D* t_ZA_sig=unroll(th2_ZA_sig, mjj_bins, detajj_bins, 1,1,"ZA_sig");
...
//        TH1D* t_WA=unroll(th2_WA, mjj_bins, mlla_bins, 4,4);
        TH1D* t_WA=unroll(th2_WA, mjj_bins, detajj_bins, 1,1,"WA");
...
//        TH1D* t_VV=unroll(th2_VV, mjj_bins, mlla_bins, 4,4);
        TH1D* t_VV=unroll(th2_VV, mjj_bins, detajj_bins, 1,1,"VV");
...
//        TH1D* t_TTA=unroll(th2_TTA, mjj_bins, mlla_bins, 4,4);
        TH1D* t_TTA=unroll(th2_TTA, mjj_bins, detajj_bins, 1,1,"TTA");
...
//        TH1D* t_ST=unroll(th2_ST, mjj_bins, mlla_bins, 4,4);
        TH1D* t_ST=unroll(th2_ST, mjj_bins, detajj_bins, 1,1,"ST");
	...
	TFile* f_plj=TFile::Open("./2d_plj.root");
        ...
        TH1D* t_plj=unroll(th2_plj, mjj_bins, detajj_bins, 1,1,"plj");
