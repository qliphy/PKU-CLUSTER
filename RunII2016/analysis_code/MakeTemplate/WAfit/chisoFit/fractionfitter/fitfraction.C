...
//	TH1F* hdf_ = (TH1F*)fdata->Get(Form("hwaFs_pt%0.f-%0.f",lowpt,highpt));
...
//        fit->Constrain(0,0,1);
	    ...
	    Double_t fr,fr_Error,k;
            ...
            ofstream myfile(dir + Form("txt/photon_pt%0.f_%0.f.txt",lowpt,highpt),ios::out);
	    ...
	    texterror->Draw();
            gPad->SetLogy(0);
            c1->Print(Form(dir + "eps/pt%0.f_%0.fMB.eps",lowpt,highpt));
