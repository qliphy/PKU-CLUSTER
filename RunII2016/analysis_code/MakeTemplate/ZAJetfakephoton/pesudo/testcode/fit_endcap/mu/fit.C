...
TString dir = "../endcap/root/";
TString dir1 = "../endcap/roofit/txt/";
ofstream file3("../endcap/roofit/info_roofit_endcap.txt");
void fit(float lowpt, float highpt, float lowchiso, float highchiso){
//TString b="chiso5-12_";
	TFile* fdata = TFile::Open(Form(dir+"datap_lep_fake_pt%0.f-%0.f_chiso%0.f-%0.f.root",lowpt,highpt,lowchiso,highchiso));
	TFile* ftrue = TFile::Open(Form(dir+"datap_lep_photonreal_pt%0.f_%0.f.root",lowpt,highpt));
