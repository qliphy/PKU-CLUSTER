...
//=========  (Thu Aug  8 23:13:21 2019) by ROOT version6.06/09
...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(-0.1875,-82.75399,1.0625,553.8152);
   pad1->SetFillColor(0);
   ...
   ST__1->SetBinContent(1,0.7440455);
   ST__1->SetBinError(1,0.3923309);
   ST__1->SetEntries(1);
   ...
   TTA__2->SetBinContent(1,6.794459);
   TTA__2->SetBinError(1,0.9516932);
   TTA__2->SetEntries(1);
   ...
   VV__3->SetBinContent(1,6.228746);
   VV__3->SetBinError(1,1.398406);
   VV__3->SetEntries(1);
   ...
   plj__5->SetBinContent(1,200.4029);
   plj__5->SetBinError(1,6.911021);
   plj__5->SetEntries(1);
   ...
   t_ZA__6->SetBinContent(1,253.2953);
   t_ZA__6->SetBinError(1,7.296486);
   ...
   ZA_sig__7->SetBinContent(1,5.414555);
   ZA_sig__7->SetBinError(1,0.3041518);
