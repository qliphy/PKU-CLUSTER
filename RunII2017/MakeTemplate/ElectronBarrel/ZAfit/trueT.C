...
//        cout<<lowpt<<"<pt<"<<highpt<<"\t"<<ff1<<"\t"<<ff2<<"\t"<<(ff1-ff2)/(2*(ff1+ff2))<<endl;
       cout<<fabs(ff1-ff2)/(ff1+ff2)<<endl;       
	file<<fixed<<setprecision(0)<<lowpt<<"<pt<"<<fixed<<setprecision(0)<<highpt<<"\t"<<fixed<<setprecision(4)<<ff1<<"\t"<<fixed<<setprecision(4)<<ff2<<"\t"<<fixed<<setprecision(4)<<fabs(ff1-ff2)/(ff1+ff2)<<endl;
