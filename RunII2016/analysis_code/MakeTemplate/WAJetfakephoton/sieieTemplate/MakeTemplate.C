...
//   nentries = 1000;
  ...
  if(name.Contains("outDMuon")==1)  cout<<"data true "<<dt<<endl;
   ...
   if(name.Contains("outZA")){
       f1 = new TFile("./mcFake_template_t1.root","recreate");
       f1->cd();
   ...
   if(name.Contains("outDMuon")){
       f3 = new TFile("./dataFake_template_t1.root","recreate");
       f4 = new TFile("./dataTrue_template_t1.root","recreate");
   ...
   if(name.Contains("outZJets")){
       f2 = new TFile("./mcTrue_template_t1.root","recreate");
       f2->cd();
