...
//data
		...
		if (drll>0.3 && lep == 13 /*&&  (HLT_Mu1>0|| HLT_Mu2>0)*/ && ptlep1 > 20. && ptlep2 > 20. && fabs(etalep1) < 2.4 && fabs(etalep2) < 2.4 && nlooseeles == 0 && nloosemus < 3 && massVlep > 70. && massVlep < 110.  && drla2>0.7 && drla>0.7 && photonet > 20.&& fabs(photoneta) < 1.4442  && fabs(jet1eta)< 4.7 && fabs(jet2eta)<4.7 && jet1pt>30 && jet2pt>30  && drj1a>0.5 &&drj2a>0.5 && drj1l>0.5 && drj2l>0.5 && drjj>0.5 && ZGmass>100 && Mjj>150 && Mjj<400 /*&& Mjj>400 && detajj>2.5 && zepp<2.4 && delta_phi>1.9*/) {
			//if(Mjj<400) 
