...
TFile* fdataT = TFile::Open("/data/pku/home/anying/cms/CMSSW_8_0_26_patch2/analysis_code/MakeTemplate/WAfit/sieieFit/rootfiles/dataTrue_template_t1.root");
TFile* fdataF = TFile::Open("/data/pku/home/anying/cms/CMSSW_8_0_26_patch2/analysis_code/MakeTemplate/WAfit/sieieFit/rootfiles/dataFake_template_t1.root");
TFile* fmcT = TFile::Open("/data/pku/home/anying/cms/CMSSW_8_0_26_patch2/analysis_code/MakeTemplate/WAfit/sieieFit/rootfiles/mcTrue_template_t1.root");
TFile* fmcF = TFile::Open("/data/pku/home/anying/cms/CMSSW_8_0_26_patch2/analysis_code/MakeTemplate/WAfit/sieieFit/rootfiles/mcFake_template_t1.root");
...
//TFile *f0 = new TFile(Form("/data/pku/home/anying/cms/CMSSW_8_0_26_patch2/analysis_code/MakeTemplate/WAfit/rootfiles/fdata_%0.f_%0.f.root",lowpt,highpt));
...
//        TH1F* hfake_ = (TH1F*)fdata->Get(Form("hwaFc_pt%0.f-%0.f",lowpt,highpt)); 
...
//	sieie.setRange("window",0.005,0.02);
	...
	ofstream myfile1(dir + Form("txt/fakerate_pt%0.f_%0.f.txt", lowpt, highpt),ios::out);
	ofstream file(dir + Form("txt/TrueNumber_pt%0.f-%0.f.txt", lowpt, highpt),ios::out);
	ofstream file1(dir +  Form("txt/FakeNumber_pt%0.f-%0.f.txt", lowpt, highpt),ios::out);
