...
void loopPlot() {
	...
	std::string pathToTrees = "/home/pku/anying/cms/CombineDraw/MuonEndcap/rootfiles/";
...
// Setup names of data files for trees.
	...
	std::cout << "set data imformation, we have " << nDATA << "data file"
			<< std::endl;
	std::string dataLabels[nDATA] = { "2018CR_Muon","2017CR_Muon","2016CR_Muon" };
...
std::string mcLabels[nMC] ={"2018CR_ST","2017CR_ST","2016CR_ST","2018CR_TTA","2017CR_TTA","2016CR_TTA","2018CR_VV","2017CR_VV","2016CR_VV","2018CR_WA","2017CR_WA","2016CR_WA","2018CR_plj_muendcap","2017CR_plj_muendcap","2016CR_plj_muendcap","2018CR_ZA","2017CR_ZA","2016CR_ZA"};
...
//		std::string mcLabels[nMC] = {"2018CR_ST", "2018CR_TTA", "2018CR_VV","2018CR_WA","2018CR_plj_muendcap","2018CR_ZA",
//			"2017CR_ST", "2017CR_TTA", "2017CR_VV","2017CR_WA","2017CR_plj_muendcap","2017CR_ZA",
//			"2016CR_ST", "2016CR_TTA", "2016CR_VV","2016CR_WA","2016CR_plj_muendcap","2016CR_ZA", };//,"Contamination_ZA"};
