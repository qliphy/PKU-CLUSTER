...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   Bool_t PHOTON,LEPmu,LEPele,SignalRegion;
...
//   nentries=100;
  ...
  // if (Cut(ientry) < 0) continue;
      ...
      LEPmu= lep == 13 && (HLT_Mu2> 0 || HLT_Mu5>0) && ptlep1 > 20. && ptlep2 > 20. && fabs(etalep1) < 2.4 && fabs(etalep2) < 2.4  && nlooseeles == 0  && nloosemus < 3 && massVlep > 70. && massVlep < 110.;
      LEPele= lep == 11 && HLT_Ele1> 0 && ptlep1 > 25. && ptlep2 > 25. && fabs(etalep1) < 2.5 && fabs(etalep2) < 2.5  && nlooseeles < 3  && nloosemus == 0 && massVlep > 70. && massVlep < 110.;
      ...
      if( LEPmu && PHOTON )  cut0++;
      if(( LEPmu && PHOTON && !SignalRegion)==true)
      {
