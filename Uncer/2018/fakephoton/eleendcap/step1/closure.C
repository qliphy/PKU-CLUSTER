...
#define num 9
using namespace std;
Double_t lowpt[ptnumber] ={20,25,30,35,65};//j
Double_t highpt[ptnumber]={25,30,35,65,400};

Double_t lpt[num]  ={20,25,30,35,40,45,50,65,100};//i
Double_t hpt[num]={25,30,35,40,45,50,65,100,400};
...
TString dir = "/home/pku/anying/cms/RunII2018/MakeTemplate/pesudo/eleendcap/txt/";
TString dir1 = "/home/pku/anying/cms/RunII2018/MakeTemplate/pesudo/eleendcap/roofit/txt/";
...
//    cout<<fixed<<setprecision(0)<<lpt[i]<<"~"<<fixed<<setprecision(3)<<hpt[i]<<"\t"<<fabs(FakeNumber-fitFake_number)/FakeNumber<<endl;
 ...
 void run_calculate(Int_t a,Int_t b){
	...
	if(lowchiso[j]==4) low = lowchiso[j];
        if(highchiso[j]==11) high = highchiso[j];
     }
