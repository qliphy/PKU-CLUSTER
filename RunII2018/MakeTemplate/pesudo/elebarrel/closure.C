...
ofstream file1(dir4 + b+"_closure_Fake.txt");
...
//    file<<Form("%0.f  <pt<%0.f ",lowpt,highpt)<<"\t"<<Form("%0.f<chiso range<%0.f ",lowchiso,highchiso)<<"\t"<<TrueNumber<<"\t"<<fitTrue_number<<"\t"<<fitTrue_error<<"\t"<<closureTrue_test<<endl;
    ...
    file1<<Form("%0.f <pt<%0.f ",lowpt,highpt)<<"\t"<<Form("%0.f<chiso range<%0.f ",lowchiso,highchiso)<<"\t"<<FakeNumber<<"\t"<<fitFake_number<<"\t"<<fabs(FakeNumber-fitFake_number)/FakeNumber<<endl;
