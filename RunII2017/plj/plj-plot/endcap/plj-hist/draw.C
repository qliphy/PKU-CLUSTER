...
//   Double_t pt[11]={20,25,30,35,40,45,50,60,80,120,400};
   Double_t pt[8] = {20,25,30,35,50,60,100,400};
...
//   nentries=100;
  ...
  // if (Cut(ientry) < 0) continue;
      ...
      ijet=0;
      if(name.Contains("outplj")||name.Contains("Data")) scalef =1;
      if(name.Contains("ZA"))  scalef = scalef*photon_id_scale;
      for(Int_t j=0;j<6;j++)
      {
      ...
      if(name.Contains("ZA_plj")){
         if(isprompt!=1) continue;}
      if( (LEPmu || LEPele)&&PHOTON_endcap==true){ 
