...
Double_t lpt[num]= {20,25,30,40,50,70,100};
Double_t hpt[num]={25,30,40,50,70,100,400};
...
TString dir = "/home/pku/anying/cms/RunII2017/MakeTemplate/pesudo/barrel/txt/";
TString dir1 = "/home/pku/anying/cms/RunII2017/MakeTemplate/pesudo/barrel/roofit/txt/";
void calculate(Double_t lowpt,Double_t highpt,Double_t lowchiso,Double_t highchiso,int i){
    ...
    if(!f3.is_open()){cout<<"can not open the file "<<Form(dir + b+"mfakenumber_pt%0.f-%0.f_chiso%0.f-%0.f.txt",lowpt,highpt,lowchiso,highchiso)<<endl;}
