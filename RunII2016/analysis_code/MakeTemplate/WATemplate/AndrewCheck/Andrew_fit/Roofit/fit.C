...
TString dir_root="/data/pku/home/anying/cms/analysis_code/MakeTemplate/WATemplate/AndrewCheck/Andrew_fit/rootfiles/";
TFile* fdataT = TFile::Open(dir_root+"dataTrue_template_check.root");
TFile* fdataF = TFile::Open(dir_root+"dataFake_template_check.root");
TFile* fmcT = TFile::Open(dir_root+"mcTrue_template_check.root");
TFile* fmcF = TFile::Open(dir_root+"mcFake_template_check.root");
TFile* fdata = TFile::Open(dir_root+"waData_template.root");
TFile* fmc = TFile::Open(dir_root+"waMC_template.root");
