...
//		actualWeight = lumiWeight * pileupWeight * scalef;
		actualWeight = lumiWeight * scalef;
...
//		else drll = sqrt((etalep1-etalep2)*(etalep1-etalep2)+(fabs(philep1-philep2))*(fabs(philep1-philep2)));
		...
		if (isnotwets > 0 || iswjets > 0 || iszjets > 0 || isttjets > 0) {
			...
			if((Mjj<400 && detajj>2.5)||(Mjj>=400 && Mjj<1500 && detajj<=2.5))(theHistograms["Mjj_control1"])->Fill(Mjj, actualWeight);
...
/*		if(photonet>120.) actualWeight = scale_plj[8];
		...
		actualWeight = scalef;
		if (drll>0.3&&lep == 11 &&  (HLT_Ele1>0 || HLT_Ele2 > 0) && ptlep1 > 25. && ptlep2 > 25. && fabs(etalep1) < 2.5 && fabs(etalep2) < 2.5 && nlooseeles < 3 && nloosemus == 0 && massVlep > 70. && massVlep < 110. && photonet > 20. && fabs(photoneta) < 1.4442 && jet1pt> 30 && jet2pt > 30 && fabs(jet1eta)< 4.7 && fabs(jet2eta)<4.7 && Mjj > 400 && drjj > 0.5 && drj1l > 0.5 && drj1l2 > 0.5 && drj2l > 0.5 && drj2l2 > 0.5 && detajj>2.5 && zepp<2.4 && ZGmass>100&& delta_phi>1.9/*&&drjj > 0.5&& drj1l > 0.5 && drj1l2 > 0.5 && drj2l > 0.5 && drj2l2 > 0.5&&detajj>1.9 &&delta_phi>2.26&&zepp<1.18&& photonet>200. && Mjj>400*/ /*&& lep == 13 &&((run_period<7 && HLT_Mu2 > 0)|| (run_period==7 && HLT_Mu1 > 0) ||(run_period==8 && (HLT_Mu1 > 0) ))  && ptlep1 > 20. && ptlep2 > 20. &&fabs(etalep1) < 2.4 &&fabs(etalep2) < 2.4 && nlooseeles == 0 && nloosemus < 3 && massVlep >70. && massVlep < 110*/) {
...
//                else drll = sqrt((etalep1-etalep2)*(etalep1-etalep2)+(fabs(philep1-philep2))*(fabs(philep1-philep2)));
	...
	cout << "after cut: " << numbe_out << "*actualweight" << actualWeight
		<< " result " << sum<<"; yields = "<<sum*57.1<< endl;
	this->saveAllHistos(outFileName);
}
