  ...
  , effectiveAreas_( (iConfig.getParameter<edm::FileInPath>("effAreasConfigFile")).fullPath() )
{
  ...
  if( (idLabel_.compare("tight")==0) || 
    ...
    applyTightID_ = true;
      ...
      (idLabel_.compare("FAKE")==0) ||
      (idLabel_.compare("FAKEID")==0) ||
      (idLabel_.compare("FakeId")==0) )  applyFakeEleID_ = true;
}
...
//    const reco::GsfElectronPtr& gsfele = electrons->at(iElec);
...
*/
    ...
    if(applyFakeEleID_ && isVeto && !isMedium) isPassing[iElec]= true;
