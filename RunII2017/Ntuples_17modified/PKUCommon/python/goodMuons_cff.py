...
loosetightMuIdLabel = "loosetight"
...
loosetightMuons = cms.EDProducer("PATMuonIdSelector",
    src = cms.InputTag( "slimmedMuons" ),
    vertex = cms.InputTag("offlineSlimmedPrimaryVertices"),
    idLabel = cms.string(loosetightMuIdLabel)
)   
...
muSequence = cms.Sequence(goodMuons+looseMuons+loosetightMuons)
