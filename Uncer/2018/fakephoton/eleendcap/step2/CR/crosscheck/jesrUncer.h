...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Double_t        deltaetajj;
   Double_t        deltaetajj_new;
   Double_t        deltaetajj_JEC_up;
   Double_t        deltaetajj_JEC_down;
   Double_t        deltaetajj_JER_up;
   Double_t        deltaetajj_JER_down;
   Double_t        deltaetajj_f;
   Double_t        deltaetajj_new_f;
   Double_t        deltaetajj_JEC_up_f;
   Double_t        deltaetajj_JEC_down_f;
   Double_t        deltaetajj_JER_up_f;
   Double_t        deltaetajj_JER_down_f;
   Double_t        zepp;
   Double_t        zepp_new;
   ...
   TBranch        *b_deltaetajj_new;   //!
   TBranch        *b_deltaetajj_JEC_up;   //!
   TBranch        *b_deltaetajj_JEC_down;   //!
   TBranch        *b_deltaetajj_JER_up;   //!
   TBranch        *b_deltaetajj_JER_down;   //!
   TBranch        *b_deltaetajj_f;   //!
   TBranch        *b_deltaetajj_new_f;   //!
   TBranch        *b_deltaetajj_JEC_up_f;   //!
   TBranch        *b_deltaetajj_JEC_down_f;   //!
   TBranch        *b_deltaetajj_JER_up_f;   //!
   TBranch        *b_deltaetajj_JER_down_f;   //!
   TBranch        *b_zepp;   //!
   TBranch        *b_zepp_new;   //!
...
void jesrUncer::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("deltaetajj_new", &deltaetajj_new, &b_deltaetajj_new);
   fChain->SetBranchAddress("deltaetajj_JEC_up", &deltaetajj_JEC_up, &b_deltaetajj_JEC_up);
   fChain->SetBranchAddress("deltaetajj_JEC_down", &deltaetajj_JEC_down, &b_deltaetajj_JEC_down);
   fChain->SetBranchAddress("deltaetajj_JER_up", &deltaetajj_JER_up, &b_deltaetajj_JER_up);
   fChain->SetBranchAddress("deltaetajj_JER_down", &deltaetajj_JER_down, &b_deltaetajj_JER_down);
   fChain->SetBranchAddress("deltaetajj_f", &deltaetajj_f, &b_deltaetajj_f);
   fChain->SetBranchAddress("deltaetajj_new_f", &deltaetajj_new_f, &b_deltaetajj_new_f);
   fChain->SetBranchAddress("deltaetajj_JEC_up_f", &deltaetajj_JEC_up_f, &b_deltaetajj_JEC_up_f);
   fChain->SetBranchAddress("deltaetajj_JEC_down_f", &deltaetajj_JEC_down_f, &b_deltaetajj_JEC_down_f);
   fChain->SetBranchAddress("deltaetajj_JER_up_f", &deltaetajj_JER_up_f, &b_deltaetajj_JER_up_f);
   fChain->SetBranchAddress("deltaetajj_JER_down_f", &deltaetajj_JER_down_f, &b_deltaetajj_JER_down_f);
