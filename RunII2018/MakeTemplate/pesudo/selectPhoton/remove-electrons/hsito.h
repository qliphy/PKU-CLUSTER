...
// Sun May 26 23:46:24 2019 by ROOT version 6.06/01
// from TTree demo/demo
// found on file: fake.root
//////////////////////////////////////////////////////////
...
#ifdef hsito_cxx
hsito::hsito(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("fake.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("fake.root");
      }
...
Int_t hsito::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t hsito::LoadTree(Long64_t entry)
{
...
void hsito::Show(Long64_t entry)
{
...
Int_t hsito::Cut(Long64_t entry)
{
