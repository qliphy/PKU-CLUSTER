...
void draw(TString title[14],TH1D* h3[14],int p1);
...
void draw(TString title[14],TH1D* h3[14],int p1){
   ...
   //   l1[i]->SetTextSize();
      ...
      h2[i]->Draw("HIST");
      h1[i]->Draw("HIST same");
      l1[i]->AddEntry(h1[i],"no JEC");
      l1[i]->AddEntry(h2[i],"JEC");
//      l1[i]->Draw();
