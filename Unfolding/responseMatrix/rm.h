...
// Thu Oct  3 03:15:20 2019 by ROOT version 6.06/01
// from TTree demo/demo
// found on file: cutla-outZA-EWK.root
//////////////////////////////////////////////////////////
...
#ifdef rm_cxx
rm::rm(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/home/pku/anying/cms/file_in_cms/files_weighted/outZA-EWK.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("outZA-EWK.root");
      }
...
Int_t rm::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t rm::LoadTree(Long64_t entry)
{
