...
void xx::Init(TTree *tree)
{
   ...
   fout = new TFile("/eos/uscms/store/user/qliphy/andy/2017/cutlep/"+m_dataset, "RECREATE");
...
//inherent branches
   ...
   newtree->Branch("Mla", &Mla_f, "Mla/D");
   newtree->Branch("Mla_f", &Mla_f, "Mla_f/D");
   newtree->Branch("Mla2", &Mla2_f, "Mla2/D");
   newtree->Branch("Mla2_f", &Mla2_f, "Mla2_f/D");
   newtree->Branch("Mva", &Mva_f, "Mva/D");
   ...
   newtree->Branch("j1metPhi", &j1metPhi_f,     "j1metPhi/D");
   newtree->Branch("j1metPhi_f", &j1metPhi_f, "j1metPhi_f/D");
   newtree->Branch("j2metPhi", &j2metPhi_f,     "j2metPhi/D");
