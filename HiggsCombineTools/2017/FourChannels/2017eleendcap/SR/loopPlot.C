...
void loopPlot() {
	...
	std::string pathToTrees = "/home/pku/anying/cms/RunII2017/aa2/EleEndcap/output-slimmed-rootfiles/";
...
// Setup names of data files for trees.
	...
	std::cout << "set data imformation, we have " << nDATA << "data file"
			<< std::endl;
	std::string dataLabels[nDATA] = { "Ele" };
...
// set mc imformation
		...
		std::cout << "set data imformation, we have " << nMC << "mc file"
				<< std::endl;
		std::string mcLabels[nMC] = { "ST", "TTA", "VV", "WA","plj_eleendcap_down", "ZA" };
