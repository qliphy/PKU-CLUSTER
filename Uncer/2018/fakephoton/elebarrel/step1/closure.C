...
TString dir = "/home/pku/anying/cms/RunII2018/MakeTemplate/pesudo/elebarrel/txt/";
TString dir1 = "/home/pku/anying/cms/RunII2018/MakeTemplate/pesudo/elebarrel/roofit/txt/";
void calculate(Double_t lowpt,Double_t highpt,Double_t lowchiso,Double_t highchiso,int i){
    ...
    cout<<fixed<<setprecision(0)<<ptlow<<"~"<<fixed<<setprecision(0)<<pthigh<<"\t"<<lpt[i]<<"~"<<hpt[i]<<"\t"<<chisolow<<"~"<<chisohigh<<"\t"<<fixed<<setprecision(3)<<FakeNumber<<"\t"<<fitFake_number<<"\t"<<fabs(FakeNumber-fitFake_number)/FakeNumber<<endl;
