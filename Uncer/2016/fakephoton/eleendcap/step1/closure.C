...
#define num 4
using namespace std;
Double_t lowpt[ptnumber] ={20,25,50,80};//j
Double_t highpt[ptnumber]={25,50,80,400};

Double_t lpt[num]= {20,25,50,80};//i
Double_t hpt[num]= {25,50,80,400};
...
TString dir  = "/afs/cern.ch/user/y/yian/work/PKU-Cluster/RunII2016/analysis_code/MakeTemplate/ZAJetfakephoton/pesudo/eleendcap/txt/";
TString dir1 = "/afs/cern.ch/user/y/yian/work/PKU-Cluster/RunII2016/analysis_code/MakeTemplate/ZAJetfakephoton/pesudo/eleendcap/roofit/txt/";
...
//    cout<<fixed<<setprecision(0)<<lpt[i]<<"~"<<fixed<<setprecision(3)<<hpt[i]<<"\t"<<fabs(FakeNumber-fitFake_number)/FakeNumber<<endl;
 ...
 void run_calculate(Int_t a,Int_t b){
	...
	if(lowchiso[j]==3) low = lowchiso[j];
