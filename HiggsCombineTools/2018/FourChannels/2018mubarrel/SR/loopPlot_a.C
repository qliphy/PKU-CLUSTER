...
//	std::string pathToTrees = "/home/pku/anying/cms/file_in_cms/2018RunIIrootfiles/2018cutla/";
	std::string pathToTrees = "/home/pku/anying/cms/RunII2018/aa2/MuonBarrel/output-slimmed-rootfiles/";
...
// set mc imformation
		...
		std::string mcLabels[nMC] = {"ST", "TTA", "VV","WA",
                                            "plj_mubarrel","ZA"};//,"Contamination_ZA"};
		double kFactorsMC_array[nMC+1] = { lumiValue,lumiValue,lumiValue,lumiValue,1,lumiValue};
                const int nMC2 = 1;      
