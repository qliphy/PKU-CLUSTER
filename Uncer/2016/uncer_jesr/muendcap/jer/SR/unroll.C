...
//	const char *name[8]={"Mjj 500~800","Mjj 800~1200","Mjj 1200~2000","Mjj 500~800","Mjj 800~1200","Mjj 1200~2000","Mjj 500~1200","1200~2000"};
...
//        file2<<t_ZA[i]->GetBinContent(k+1)*scale_factor[i]<<endl;}
     ...
     t_ZA[0]->GetYaxis()->SetRangeUser(0,0.12);
     t_ZA[0]->Draw("HIST");
