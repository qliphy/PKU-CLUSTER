...
//        t_ZA[i]->DrawNormalized("HIST");
        if(i==0) ll[i]->AddEntry(t_ZA[i],"central value");
        else if(i==1)    ll[i]->AddEntry(t_ZA[i],"up value");
        else if(i==2)    ll[i]->AddEntry(t_ZA[i],"down value");
        ll[i]->Draw();
...
//          t_ZA[i]->Scale(scale_factor[i]);
          ...
          t_ZA[i]->Draw("HIST,SAME");
          if(i==0)         l2->AddEntry(t_ZA[i],"central value");
          else if(i==1)    l2->AddEntry(t_ZA[i],"up value");
          else if(i==2)    l2->AddEntry(t_ZA[i],"down value");
