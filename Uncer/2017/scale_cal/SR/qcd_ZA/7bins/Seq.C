...
//    cout<<"bin "<<j+1<<"; uncertainty["<<j<<"] = "<<uncertainty_other[j]<<endl;
     ...
     cout<<" "<<1+(biggest[j]-central_value[j])/central_value[j]<<endl;
     f1<<" "<<1+(biggest[j]-central_value[j])/central_value[j]<<endl;
  }
const char *name[p]={"Mjj 500~800","Mjj 800~1200","Mjj 1200~2000","Mjj 500~800","Mjj 800~1200","Mjj 1200~2000","Mjj 500~2000"};
