...
//	t->SetBranchAddress("deltaetajj", &deltaetajj);
	...
	{
		t->GetEntry(j);
		if( !(lep==13 && ( fabs(photoneta)>1.566 && fabs(photoneta)<2.5 )&& Mjj>150 && Mjj<400) ) continue;
...
int d_hist(){
	TH2D* h0 = run("/home/pku/anying/cms/RunII2018/aa2/ScalSeq/output-slimmed-rootfiles/optimal_2018_plj_muendcap.root",0);
	TH2D* hup = run("/home/pku/anying/cms/RunII2018/aa2/ScalSeq/output-slimmed-rootfiles/optimal_2018_plj_muendcap_up.root",1);
	TH2D* hdown = run("/home/pku/anying/cms/RunII2018/aa2/ScalSeq/output-slimmed-rootfiles/optimal_2018_plj_muendcap_down.root",2);
