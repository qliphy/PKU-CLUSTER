...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   ifstream f1;
//   f1.open("/home/pku/anying/cms/Uncer/2016/fakephoton/muendcap/step1/pljweight.txt");
//   f1.open("/home/pku/anying/cms/Uncer/2016/fakephoton/muendcap/step1/pljweight_up.txt");
   f1.open("/home/pku/anying/cms/Uncer/2016/fakephoton/muendcap/step1/pljweight_down.txt");
   Double_t scalef_f[8];
   for(Int_t i=0;i<8;i++){
      f1>>scalef_f[i];
