...
TFile* f1 = new TFile("/home/pku/anying/cms/RunII2017/plj/plj-plot/barrel/plj-hist/cutla-outplj_barrel_hb.root");
TFile* f2 = new TFile("/home/pku/anying/cms/RunII2017/plj/plj-plot/barrel/plj-hist/cutla-outData_hb.root");
TFile* f3 = new TFile("/home/pku/anying/cms/RunII2017/plj/plj-plot/barrel/plj-hist/cutla-outZA_contamination_hb.root");

TH1F* h1 = (TH1F*)f1->Get("h_cutla-outplj_barrel");
...
for(Int_t i=0;i<num;i++){
    ...
    cout<< bin_data[i]<<" "<<bin_plj[i]<<" "<<bin_za[i]<<" "<<fakefraction<<endl;
