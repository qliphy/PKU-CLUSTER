...
// Sat Sep 15 00:18:16 2018 by ROOT version 6.06/01
// from TTree demo/demo
// found on file: outDMuon_plj.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   TString m_dataset;
   draw(TTree *tree=0,TString dataset="");
   virtual ~draw();
...
#ifdef draw_cxx
draw::draw(TTree *tree,TString dataset) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("outDMuon_plj.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("outDMuon_plj.root");
      }
